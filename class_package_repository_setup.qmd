...
Paste the thing that pops up into the .RProfile page that pops up and save it.
...
Not a bad time to mention that there is a GitHub desktop app and a mobile app. I've only used the desktop one a bit but it does seem helpful!
